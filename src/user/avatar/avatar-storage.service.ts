...
import { AvatarPresignResponseDto } from './dto/avatar.dto';

@Injectable()
export class AvatarStorageService {
  private static readonly logger = new Logger(AvatarStorageService.name);
  ...
  async getSignedDownloadUrl(avatarKey: string): Promise<string> {
  ...
  async deleteObjectQuietly(key: string): Promise<void> {
    try {
      ...
      AvatarStorageService.logger.warn(
