...
export class QueryQuestionsDto {
  @ApiPropertyOptional({
    description:
      'Free-text search over question text, role, category, subcategory, tags.',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    type: [String],
    description:
      'ANY-match: rows whose tags array overlaps the given list. Send as ?tags=react,hooks or repeated.',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    default: 'active',
    description:
      'Non-super_admin callers are forced to "active" regardless of what they pass.',
  })
  @IsOptional()
